...
class Difunto extends AppModel {
    ...
    public $filterArgs = array(
        ...
        'tumba_id' => array('type' => 'value', 'field' => 'Difunto.tumba_id'),
        'estado' => array('type' => 'value', 'field' => 'Difunto.estado'),
        'desde' => array('type' => 'query', 'method' => 'consultaFecha'),
        'hasta' => array('type' => 'query', 'method' => 'consultaFecha'),
        'edad' => array('type' => 'value', 'field' => 'Difunto.edad'),
        'causa_fundamental' => array('type' => 'like', 'field' => 'Difunto.causa_fundamental'),
        'causa_inmediata' => array('type' => 'like', 'field' => 'Difunto.causa_inmediata'),
        'certificado_defuncion' => array('type' => 'like', 'field' => 'Difunto.certificado_defuncion'),
