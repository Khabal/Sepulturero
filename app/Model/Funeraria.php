...
class Funeraria extends AppModel {
    ...
    public $virtualFields = array(
        ...
        'telefono_fijo' => 'Funeraria.telefono_fijo',
        'telefono_movil' => 'Funeraria.telefono_movil',
        'fax' => 'Funeraria.fax',
    ...
    public $validate = array(
        ...
        'telefono_fijo' => array(
            'novacio' => array(
                ...
                'allowEmpty' => false,
                'on' => null,
                'message' => 'El número de teléfono fijo no se puede dejar en blanco.',
            ),
            'longitud' => array(
                ...
                'allowEmpty' => false,
                'on' => null,
                'message' => 'El número de teléfono fijo debe tener entre 9 y 12 caracteres.',
            ),
            'solonumeros' => array(
                'rule' => '/^[0-9]/',
                'required' => true,
                'allowEmpty' => false,
                'on' => null,
                'message' => 'El número de teléfono fijo sólo puede contener caracteres numéricos.',
            ),
        ),
        'telefono_movil' => array(
            'longitud' => array(
                ...
                'allowEmpty' => true,
                'on' => null,
                'message' => 'El número de teléfono móvil debe tener entre 9 y 12 caracteres.',
            ),
            'solonumeros' => array(
                'rule' => '/^[0-9]/',
                'required' => false,
                'allowEmpty' => true,
                'on' => null,
                'message' => 'El número de teléfono móvil sólo puede contener caracteres numéricos.',
            ),
        ),
        'fax' => array(
            'longitud' => array(
    ...
    public $filterArgs = array(
        'cif' => array('type' => 'like', 'field' => 'Funeraria.cif'),
        'nombre' => array('type' => 'like', 'field' => 'Funeraria.nombre'),
        'direccion' => array('type' => 'like', 'field' => 'Funeraria.direccion'),
        'telefono_fijo' => array('type' => 'like', 'field' => 'Funeraria.telefono_fijo'),
        'telefono_movil' => array('type' => 'like', 'field' => 'Funeraria.telefono_movil'),
        'fax' => array('type' => 'like', 'field' => 'Funeraria.fax'),
        'correo_electronico' => array('type' => 'like', 'field' => 'Funeraria.correo_electronico'),
        'pagina_web' => array('type' => 'like', 'field' => 'Funeraria.pagina_web'),
