...
class Arrendamiento extends AppModel {
    ...
    public $validate = array(
        ...
        'estado' => array(
            ...
            'solo_un_vigente' => array(
                'rule' => array('valida_arrendamiento_vigente'),
                'required' => true,
                'allowEmpty' => false,
                'on' => null,
                'message' => 'Ya hay un arrendamiento vigente para esta tumba.',
            ),
            'solo_un_caducado' => array(
                'rule' => array('valida_arrendamiento_caducado'),
                'required' => true,
                'allowEmpty' => false,
                'on' => null,
                'message' => 'Ya hay un arrendamiento caducado para esta tumba.',
            ),
        ),
        'observaciones' => array(
    ...
    /**
     * valida_arrendamiento_vigente method
     *
     * @param array $check elements for validate
     * @return boolean
     */
    public function valida_arrendamiento_vigente($check) {
        ...
        //Comprobar si el estado del arrendamiento es "Vigente"
        if ($estado == "Vigente") {
            //Buscar si ya había otro arrendamiento "Vigente" para esta tumba
            ...
            //Comprobar si existe otro arrendamiento "Vigente" para esta tumba
            if ($arrendador > 0) {
                //Devolver error
                return false;
            }
    ...
    /**
     * valida_arrendamiento_caducado method
     *
     * @param array $check elements for validate
     * @return boolean
     */
    public function valida_arrendamiento_caducado($check) {
        ...
        //Comprobar si el estado del arrendamiento es "Caducado"
        if ($estado == "Caducado") {
            //Buscar si ya había otro arrendamiento "Caducado" para esta tumba
            $arrendador = $this->find('count', array(
             'conditions' => array(
              'Arrendamiento.id !=' => $id,
              'Arrendamiento.tumba_id' => $tumba,
            ...
            //Comprobar si existe otro arrendamiento "Caducado" para esta tumba
            if ($arrendador > 0) {
                //Devolver error
                return false;
            }
    ...
    public $filterArgs = array(
        ...
        'arrendatario_id' => array('type' => 'value', 'field' => 'Arrendamiento.arrendatario_id'),
        'concesion' => array('type' => 'query', 'method' => 'consultaConcesion'),
        'concesion_id' => array('type' => 'value', 'field' => 'Arrendamiento.concesion_id'),
        'tumba' => array('type' => 'query', 'method' => 'consultaTumba'),
        'tumba_id' => array('type' => 'value', 'field' => 'Arrendamiento.tumba_id'),
        'desde' => array('type' => 'query', 'method' => 'consultaFecha'),
        'hasta' => array('type' => 'query', 'method' => 'consultaFecha'),
        'estado' => array('type' => 'value', 'field' => 'Arrendamiento.estado'),
