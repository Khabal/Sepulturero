...
<div class="actions box">
 ...
 <?php echo $this->GuarritasEnergeticas->guarrita_menu_extendido('arrendamientos', $this->Session->read('Arrendamiento.id'), $this->Session->read('Arrendamiento.identificador')); ?>
</div>
