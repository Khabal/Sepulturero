...
<div class="actions box">
 ...
 <?php echo $this->GuarritasEnergeticas->guarrita_menu_extendido(strtolower($this->name), $this->Session->read('Enterramiento.id'), $this->Session->read('Enterramiento.identificador')); ?>
</div>
