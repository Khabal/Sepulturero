...
class ConcesionesController extends AppController {
    ...
    public function nuevo() {
        ...
        //Devolver las opciones de selección de unidades de tiempo
        $this->set('tiempo', $this->Concesion->tiempo);
    ...
    public function imprimir($id = null) {
        ...
        $this->pdfConfig['filename'] = $concesion['Concesion']['duracion'] . $concesion['Concesion']['unidad_tiempo'] . ".pdf";
    ...
    public function autocomplete() {
        ...
        $resultados = $this->Concesion->find('all', array(
         ...
         'conditions' => array(
          'OR' =>  array(
           ...
           'Concesion.duracion' => $palabro,
           'Concesion.unidad_tiempo' => $palabro,
          ),
         ),
         'limit' => 20,
        ));
        ...
        if (empty($resultados)) {
            ...
            foreach($resultados as $resultado) {
                array_push($items, array("label" => $resultado['Concesion']['tipo'] . " - " . $resultado['Concesion']['duracion'] . " " . $resultado['Concesion']['unidad_tiempo'], "value" => $resultado['Concesion']['id']));
            }
        }
