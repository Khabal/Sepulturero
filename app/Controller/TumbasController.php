...
class TumbasController extends AppController {
     ...
     * @var array
     */
    public $uses = array('Tumba', 'Columbario', 'Exterior', 'Nicho', 'Panteon', 'TrasladoTumba', 'Traslado', 'Persona', 'Difunto', 'DifuntoTraslado', 'ArrendatarioTumba', 'Arrendatario', 'Enterramiento', 'Sanitize');
